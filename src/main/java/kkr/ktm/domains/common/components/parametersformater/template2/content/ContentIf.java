...
public class ContentIf extends ContentBase implements Content, Open {
	...
	public ContentIf(Position position, Map<String, String> attributes) throws ContentParseException {
		...
		try {
			...
			// NAME
			//
			if (attributesLocal.containsKey(TagIf.ATTR_NAME)) {
				String attributeValue = attributesLocal.remove(TagIf.ATTR_NAME);
			...
			// VALUE
			//
			if (attributesLocal.containsKey(TagIf.ATTR_VALUE)) {
			...
			if (attributesLocal.containsKey(ATTR_TYPE)) {
				String attributeValue = attributesLocal.remove(TagIf.ATTR_TYPE);
				try {
