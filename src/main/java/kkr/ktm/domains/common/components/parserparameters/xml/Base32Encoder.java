...
public class Base32Encoder {
    ...
    private static final String base32Chars = "ABCDEFGHJKLMNPRSTUWXYZ23456789";
    ...
    static public void main(String[] args) {
        ...
        byte[] decoded = Base32Encoder.decode(args[0]);
        ...
        System.out.println();
        System.out.println("Reencoded: " + Base32Encoder.encode(decoded));
    }
}
