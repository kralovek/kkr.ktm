...
public class FileManagerFtpApacheCommons extends FileManagerFtpApacheCommonsFwk implements FileManager {
	private static final Logger LOG = Logger.getLogger(FileManagerFtpApacheCommons.class);
